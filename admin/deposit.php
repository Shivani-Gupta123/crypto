...
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Deposit list</h3>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["deposit-table"]=$("#deposit-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/finance\/deposit","type":"GET","data":function(data) {
