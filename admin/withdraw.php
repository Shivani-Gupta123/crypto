...
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Withdraw list</h3>
</div>

<div class="table-responsive">
<table class="table" id="withdraw-table"><thead><tr><th title="Sl" width="30">Sl</th><th title="User">User</th><th title="Payment gateway">Payment gateway</th><th title="Amount">Amount</th><th title="Fees">Fees</th><th title="Comments">Comments</th><th title="Status">Status</th><th title="Created at">Created at</th><th title="Updated at">Updated at</th><th title="Action" width="60">Action</th></tr></thead></table>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["withdraw-table"]=$("#withdraw-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/finance\/withdraw","type":"GET","data":function(data) {
