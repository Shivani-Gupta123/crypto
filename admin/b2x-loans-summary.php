...
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Loan summary</h3>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["b2x-loan-table"]=$("#b2x-loan-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/b2x-loans-summary","type":"GET","data":function(data) {
