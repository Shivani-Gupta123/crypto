...
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Verified canceled customers
</h3>
</div>

<div class="table-responsive">
<table class="table" id="customer-verify-doc-tbl"><thead><tr><th title="Sl" width="30">Sl</th><th title="User id">User id</th><th title="Name">Name</th><th title="Email">Email</th><th title="Phone">Phone</th><th title="Referral user">Referral user</th></tr></thead></table>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["customer-verify-doc-tbl"]=$("#customer-verify-doc-tbl").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/verified-canceled","type":"GET","data":function(data) {
            ...
            delete data.search.regex;}},"columns":[{"data":"DT_RowIndex","name":"DT_RowIndex","title":"Sl","orderable":false,"searchable":false,"width":30,"className":"text-center"},{"data":"user_id","name":"user_id","title":"User id","orderable":true,"searchable":true,"className":"text-center"},{"data":"first_name","name":"first_name","title":"Name","orderable":true,"searchable":true},{"data":"email","name":"email","title":"Email","orderable":true,"searchable":true},{"data":"phone","name":"phone","title":"Phone","orderable":true,"searchable":true},{"data":"referral_user","name":"referral_user","title":"Referral user","orderable":true,"searchable":true}],"order":[[0,"desc"]],"dom":"<'row m-3'<'col-md-4'l><'col-md-4 text-center'B><'col-md-4'f>>rt<'bottom'<'row'<'col-md-6'i><'col-md-6'p>>><'clear'>","responsive":true,"autoWidth":false,"headerCallback":function(thead, data, start, end, display) {
                            $(thead).addClass("bg-primary");
                            $(thead).find("th").addClass("text-white");
                            $("#customer-verify-doc-tbl").removeClass("table-striped table-hover");
