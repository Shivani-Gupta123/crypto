...
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Pending withdraw</h3>
</div>

<div class="table-responsive">
<table class="table" id="deposit-table"><thead><tr><th title="Sl" width="30">Sl</th><th title="User id">User id</th><th title="Payment gateway">Payment gateway</th><th title="Credential">Credential</th><th title="Amount">Amount</th><th title="Fees">Fees</th><th title="Comments">Comments</th><th title="Status">Status</th><th title="Created at">Created at</th><th title="Updated at">Updated at</th><th title="Action" width="60">Action</th></tr></thead></table>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["deposit-table"]=$("#deposit-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/finance\/pending-withdraw","type":"GET","data":function(data) {
            ...
            delete data.search.regex;}},"columns":[{"data":"DT_RowIndex","name":"DT_RowIndex","title":"Sl","orderable":false,"searchable":false,"width":30,"className":"text-center"},{"data":"user_id","name":"user_id","title":"User id","orderable":true,"searchable":true},{"data":"payment_gateway_id","name":"payment_gateway_id","title":"Payment gateway","orderable":false,"searchable":false},{"data":"credential","name":"credential","title":"Credential","orderable":false,"searchable":false},{"data":"amount","name":"amount","title":"Amount","orderable":false,"searchable":false},{"data":"fees","name":"fees","title":"Fees","orderable":false,"searchable":false,"className":"text-center"},{"data":"comments","name":"comments","title":"Comments","orderable":true,"searchable":true},{"data":"status","name":"status","title":"Status","orderable":true,"searchable":true,"className":"text-center"},{"data":"created_at","name":"created_at","title":"Created at","orderable":true,"searchable":true},{"data":"updated_at","name":"updated_at","title":"Updated at","orderable":true,"searchable":true},{"data":"action","name":"action","title":"Action","orderable":false,"searchable":false,"width":60,"className":"text-center"}],"order":[[0,"desc"]],"dom":"<'row m-3'<'col-md-4'l><'col-md-4 text-center'B><'col-md-4'f>>rt<'bottom'<'row'<'col-md-6'i><'col-md-6'p>>><'clear'>","responsive":true,"autoWidth":false,"headerCallback":function(thead, data, start, end, display) {
                            $(thead).addClass("bg-primary");
                            $(thead).find("th").addClass("text-white");
                            $("#deposit-table").removeClass("table-striped table-hover");
...
<script src="https://nishuelaravel.bdtask-demo.com/backend/module-assets/Finance/js/withdraw.js"></script>
