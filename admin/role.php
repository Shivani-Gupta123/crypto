...
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Role</h3>
<div class="d-flex align-items-center gap-2">
<div class="border radius-10 p-1">
<button id="add-role-button" data-bs-toggle="modal" data-bs-target="#addRole" class="btn btn-save lh-sm">
...
<table class="table" id="roles-table"><thead><tr><th title="Sl" width="30">Sl</th><th title="Name">Name</th><th title="Created at">Created at</th><th title="Updated at">Updated at</th><th title="Action" width="100">Action</th></tr></thead></table>
</div>
...
<h5 class="modal-title text-color-5 fs-20 fw-medium" id="modelLabel">Create role
</h5>
<button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
</div>
<div class="modal-body p-4 pt-2">
<form action="https://nishuelaravel.bdtask-demo.com/backend/admin/role" method="post" class="needs-validation" data="showCallBackData" id="role-form" novalidate data-insert="https://nishuelaravel.bdtask-demo.com/backend/admin/role" enctype="multipart/form-data">
<input type="hidden" name="_token" value="wg4G36cOThJoNQEBu6DmGlNtTZKtBuYYQpsofzKm" autocomplete="off"> <div class="row mb-3">
<div class="col-12">
<div class="mb-3">
<label class="col-form-label text-start text-color-1 fs-16 fw-medium" for="name">Name <span class="text-danger">*</span>
</label>
<input type="text" name="name" id="name" value class="custom-form-control  form-control " placeholder="Enter role name" required />
...
<button type="submit" class="actionBtn btn btn-save py-2 w-75" id="roleFormActionBtn">Create</button>
</div>
</form>
</div>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["roles-table"]=$("#roles-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/role","type":"GET","data":function(data) {
...
<script src="https://nishuelaravel.bdtask-demo.com/backend/assets/js/setting/role.min.js"></script>
