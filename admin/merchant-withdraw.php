...
<table class="table" id="merchant-withdraw-table"><thead><tr><th title="Sl" width="30">Sl</th><th title="Date">Date</th><th title="Store name">Store name</th><th title="User id">User id</th><th title="Method">Method</th><th title="Amount">Amount</th><th title="Fees">Fees</th><th title="Comments">Comments</th><th title="Status">Status</th><th title="Action" width="60">Action</th></tr></thead></table>
</div>
