...
<table class="table" id="transactions-logs"><thead><tr><th title="Sl" width="30">Sl</th><th title="User id">User id</th><th title="Coin">Coin</th><th title="Transaction">Transaction</th><th title="Type">Type</th><th title="Amount">Amount</th><th title="Created at">Created at</th></tr></thead></table>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["transactions-logs"]=$("#transactions-logs").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/reports\/transactions-logs","type":"GET","data":function(data) {
            ...
            delete data.search.regex;}},"columns":[{"data":"DT_RowIndex","name":"DT_RowIndex","title":"Sl","orderable":false,"searchable":false,"width":30,"className":"text-center"},{"data":"user_id","name":"user_id","title":"User id","orderable":true,"searchable":true},{"data":"accept_currency_id","name":"accept_currency_id","title":"Coin","orderable":true,"searchable":true,"className":"text-center"},{"data":"transaction","name":"transaction","title":"Transaction","orderable":true,"searchable":true,"className":"text-center"},{"data":"transaction_type","name":"transaction_type","title":"Type","orderable":true,"searchable":true,"className":"text-center"},{"data":"amount","name":"amount","title":"Amount","orderable":true,"searchable":true},{"data":"created_at","name":"created_at","title":"Created at","orderable":true,"searchable":true}],"order":[[0,"desc"]],"dom":"<'row m-3'<'col-md-4'l><'col-md-4 text-center'B><'col-md-4'f>>rt<'bottom'<'row'<'col-md-6'i><'col-md-6'p>>><'clear'>","responsive":true,"autoWidth":false,"headerCallback":function(thead, data, start, end, display) {
                            $(thead).addClass("bg-primary");
                            $(thead).find("th").addClass("text-white");
                            $("#transactions-logs").removeClass("table-striped table-hover");
