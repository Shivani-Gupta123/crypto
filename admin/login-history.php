...
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Login history</h3>
</div>

<div class="table-responsive">
<table class="table" id="login-history"><thead><tr><th title="Sl" width="30">Sl</th><th title="User id">User id</th><th title="Type">Type</th><th title="Access time">Access time</th><th title="User agent">User agent</th><th title="User ip">User ip</th></tr></thead></table>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["login-history"]=$("#login-history").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/reports\/login-history","type":"GET","data":function(data) {
            ...
            delete data.search.regex;}},"columns":[{"data":"DT_RowIndex","name":"DT_RowIndex","title":"Sl","orderable":false,"searchable":false,"width":30,"className":"text-center"},{"data":"user_id","name":"user_id","title":"User id","orderable":true,"searchable":true,"className":"text-center"},{"data":"type","name":"type","title":"Type","orderable":true,"searchable":true,"className":"text-center"},{"data":"access_time","name":"access_time","title":"Access time","orderable":false,"searchable":false},{"data":"user_agent","name":"user_agent","title":"User agent","orderable":false,"searchable":false,"className":"text-center"},{"data":"user_ip","name":"user_ip","title":"User ip","orderable":false,"searchable":false}],"order":[[0,"desc"]],"dom":"<'row m-3'<'col-md-4'l><'col-md-4 text-center'B><'col-md-4'f>>rt<'bottom'<'row'<'col-md-6'i><'col-md-6'p>>><'clear'>","responsive":true,"autoWidth":false,"headerCallback":function(thead, data, start, end, display) {
                            $(thead).addClass("bg-primary");
                            $(thead).find("th").addClass("text-white");
                            $("#login-history").removeClass("table-striped table-hover");
