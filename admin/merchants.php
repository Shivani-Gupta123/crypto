...
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Merchants</h3>
</div>

<div class="table-responsive">
<table class="table" id="merchant-application-table"><thead><tr><th title="Sl" width="30">Sl</th><th title="User id">User id</th><th title="Date">Date</th><th title="User">User</th><th title="Name">Name</th><th title="Email">Email</th><th title="Phone">Phone</th><th title="Website url">Website url</th><th title="Logo">Logo</th><th title="About">About</th><th title="Status">Status</th><th title="Action" width="60">Action</th></tr></thead></table>
</div>
