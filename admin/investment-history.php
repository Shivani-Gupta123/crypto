...
<div class="card py-4 px-3 radius-15">
<div class="d-flex flex-column flex-lg-row gap-3 justify-content-between align-items-center mb-3">
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Transaction logs</h3>
</div>

<div class="table-responsive">
<table class="table" id="investment-history"><thead><tr><th title="Sl" width="30">Sl</th><th title="User id">User id</th><th title="Package">Package</th><th title="Invest amount">Invest amount</th><th title="Invest qty">Invest qty</th><th title="Total invest amount">Total invest amount</th><th title="Expiry date">Expiry date</th><th title="Create date">Create date</th><th title="Status">Status</th></tr></thead></table>
</div>
...
<script src="https://nishuelaravel.bdtask-demo.com/backend/assets/js/pages/app.select2.js"></script>
<script src="https://nishuelaravel.bdtask-demo.com/backend/assets/js/custom.js"></script>
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["investment-history"]=$("#investment-history").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/reports\/investment-history","type":"GET","data":function(data) {
            for (var i = 0, len = data.columns.length; i < len; i++) {
                if (!data.columns[i].search.value) delete data.columns[i].search;
                if (data.columns[i].searchable === true) delete data.columns[i].searchable;
                if (data.columns[i].orderable === true) delete data.columns[i].orderable;
            ...
            delete data.search.regex;}},"columns":[{"data":"DT_RowIndex","name":"DT_RowIndex","title":"Sl","orderable":false,"searchable":false,"width":30,"className":"text-center"},{"data":"user_id","name":"user_id","title":"User id","orderable":true,"searchable":true,"className":"text-center"},{"data":"package_id","name":"package_id","title":"Package","orderable":true,"searchable":true},{"data":"invest_amount","name":"invest_amount","title":"Invest amount","orderable":false,"searchable":false},{"data":"invest_qty","name":"invest_qty","title":"Invest qty","orderable":false,"searchable":false,"className":"text-center"},{"data":"total_invest_amount","name":"total_invest_amount","title":"Total invest amount","orderable":false,"searchable":false},{"data":"expiry_at","name":"expiry_at","title":"Expiry date","orderable":true,"searchable":true},{"data":"created_at","name":"created_at","title":"Create date","orderable":true,"searchable":true},{"data":"status","name":"status","title":"Status","orderable":true,"searchable":true}],"order":[[0,"desc"]],"dom":"<'row m-3'<'col-md-4'l><'col-md-4 text-center'B><'col-md-4'f>>rt<'bottom'<'row'<'col-md-6'i><'col-md-6'p>>><'clear'>","responsive":true,"autoWidth":false,"headerCallback":function(thead, data, start, end, display) {
                            $(thead).addClass("bg-primary");
                            $(thead).find("th").addClass("text-white");
                            $("#investment-history").removeClass("table-striped table-hover");
                        },"buttons":[{"extend":"excel","text":"<i class=\"fa fa-file-excel\"><\/i> Excel","className":"btn btn-success box-shadow--4dp btn-sm-menu"},{"extend":"csv","text":"<i class=\"fa fa-file-csv\"><\/i> CSV","className":"btn btn-success box-shadow--4dp btn-sm-menu"},{"extend":"pdf","text":"<i class=\"fa fa-file-pdf\"><\/i> PDF","className":"btn btn-success box-shadow--4dp btn-sm-menu"},{"extend":"print","text":"<i class=\"fa fa-print\"><\/i> Print","className":"btn btn-success box-shadow--4dp btn-sm-menu","attr":{"target":"_blank"}},{"extend":"reset","text":"<i class=\"fa fa-undo-alt\"><\/i> Reset","className":"btn btn-success box-shadow--4dp btn-sm-menu"}]});});</script>
<script src="https://nishuelaravel.bdtask-demo.com/backend/assets/js/datatables.active.min.js"></script>
