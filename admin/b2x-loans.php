...
<h3 class="fs-24 mb-0 text-color-2 fw-medium lh-1">Loan applications</h3>
</div>

<div class="table-responsive">
<table class="table" id="b2x-loan-table"><thead><tr><th title="Sl" width="30">Sl</th><th title="Date">Date</th><th title="Name">Name</th><th title="Package">Package</th><th title="Interest (%)">Interest (%)</th><th title="Loan amount">Loan amount</th><th title="Hold amount">Hold amount</th><th title="Installment">Installment</th><th title="Paid inst">Paid inst</th><th title="Remain inst">Remain inst</th><th title="Status">Status</th><th title="Action" width="60">Action</th></tr></thead></table>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["b2x-loan-table"]=$("#b2x-loan-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/b2x-loans","type":"GET","data":function(data) {
