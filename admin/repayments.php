...
<table class="table" id="b2x-repay-table"><thead><tr><th title="Sl" width="30">Sl</th><th title="Currency">Currency</th><th title="User id">User id</th><th title="Loan amount">Loan amount</th><th title="Installment">Installment</th><th title="Repay amount">Repay amount</th><th title="Payment time">Payment time</th><th title="Paid time">Paid time</th><th title="Status">Status</th></tr></thead></table>
</div>
...
<script type="text/javascript">$(function(){window.LaravelDataTables=window.LaravelDataTables||{};window.LaravelDataTables["b2x-repay-table"]=$("#b2x-repay-table").DataTable({"serverSide":true,"processing":true,"ajax":{"url":"https:\/\/nishuelaravel.bdtask-demo.com\/backend\/admin\/repayments","type":"GET","data":function(data) {
            ...
            delete data.search.regex;}},"columns":[{"data":"DT_RowIndex","name":"DT_RowIndex","title":"Sl","orderable":false,"searchable":false,"width":30,"className":"text-center"},{"data":"currency","name":"currency","title":"Currency","orderable":false,"searchable":false,"className":"text-center"},{"data":"user_id","name":"user_id","title":"User id","orderable":false,"searchable":false},{"data":"loan_amount","name":"loan_amount","title":"Loan amount","orderable":false,"searchable":false},{"data":"installment_amount","name":"installment_amount","title":"Installment","orderable":false,"searchable":false},{"data":"amount","name":"amount","title":"Repay amount","orderable":true,"searchable":true},{"data":"created_at","name":"created_at","title":"Payment time","orderable":true,"searchable":true},{"data":"updated_at","name":"updated_at","title":"Paid time","orderable":true,"searchable":true},{"data":"status","name":"status","title":"Status","orderable":true,"searchable":true,"className":"text-center"}],"order":[[0,"desc"]],"dom":"<'row m-3'<'col-md-4'l><'col-md-4 text-center'B><'col-md-4'f>>rt<'bottom'<'row'<'col-md-6'i><'col-md-6'p>>><'clear'>","responsive":true,"autoWidth":false,"headerCallback":function(thead, data, start, end, display) {
                            $(thead).addClass("bg-primary");
                            $(thead).find("th").addClass("text-white");
                            $("#b2x-repay-table").removeClass("table-striped table-hover");
